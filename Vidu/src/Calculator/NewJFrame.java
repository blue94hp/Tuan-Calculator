...
public class NewJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Calculator");
        setBackground(javax.swing.UIManager.getDefaults().getColor("nbProgressBar.Foreground"));
        ...
        jButton29.setPreferredSize(new java.awt.Dimension(45, 23));
        ...
        jRadioButtonMenuItemDefault.setDebugGraphicsOptions(javax.swing.DebugGraphics.NONE_OPTION);
        jRadioButtonMenuItemDefault.setName(""); // NOI18N
        ...
        jRadioButtonMenuItemDefault.getAccessibleContext().setAccessibleDescription("");
    ...
    private void jRadioButtonMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jRadioButtonMenuItem2ActionPerformed
        add(jPanel3);
        setSize(365, 273);  
        jTextField1.setSize(340, 46);
    }//GEN-LAST:event_jRadioButtonMenuItem2ActionPerformed

    private void jRadioButtonMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jRadioButtonMenuItem1ActionPerformed
        remove(jPanel3);
        jTextField1.setSize(279, 46);
        setSize(305, 273);
